                            ...
                            <table class="table text-secondary text-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle bg-transparent border-bottom">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <img src="{{asset('assets/img/team-1.jpg')}}" class="rounded-circle mr-2"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle bg-transparent border-bottom">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <img src="{{asset('assets/img/team-3.jpg')}}" class="rounded-circle mr-2"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle bg-transparent border-bottom">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <img src="{{asset('assets/img/team-4.jpg')}}" class="rounded-circle mr-2"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle bg-transparent border-bottom">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <img src="{{asset('assets/img/marie.jpg')}}" class="rounded-circle mr-2"
